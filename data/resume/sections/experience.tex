...
\begin{rSection}{Experience}
	...
	{\textbf{\large{Amazon} \footnotesize{(Summer Undergraduate Research Experience @ CMU)}} \hfill \color{darkgray}{06/2023 - 08/2023} 
	\\ \vspace*{1mm}
	...
	\begin{minipage}{40em}
		\begin{itemize}
			...
			\item Implemented \textit{Graphicionado Graph Analytics} algorithm in \href{https://docs.calyxir.org/contributors.html}{\underline{Calyx}} as a case-study of the language and found/solved soundness bugs in the front-end.
		\end{itemize}
	\end{minipage}} 
