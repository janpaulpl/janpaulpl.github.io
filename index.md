...
This summer, I'm working with [Dr. Alwyn Goodloe](https://shemesh.larc.nasa.gov/people/aeg/) at the [Langley Formal Methods research program at NASA](https://shemesh.larc.nasa.gov/fm/index.html). We're mechanizing proofs that model _correct_ behaviors behind a Delay-Tolerant Network for NASA's Interplanetary Overlay Network framework.
